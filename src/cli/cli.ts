...
import { SlidingWindowMemoryManager } from '../core/memory/memory';
import { CalculatorAgent } from '../agents/calculator/CalculatorAgent';
import { WeatherAgent } from '../agents/weather/WeatherAgent';
import { ManagerAgent } from '../agents/manager/ManagerAgent';
import { registerAgent } from '../core/agent/AgentRegistry';
import { initializeLogger, getLogger } from '../infrastructure/logging/implementations/logger';
